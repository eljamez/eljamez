...
export default function HomePageAboutContent() {
  return (
    <div className="fadeIn flex flex-col items-center justify-center max-w-2xl mx-auto">
      <Link
        href="/about"
        className="text-2xl md:text-4xl font-bold text-green-400 mb-4 hover:text-green-500"
      >
        About Me
      </Link>
