  ...
  return (
    <div className="fadeIn px-2 sm:px-0">
      <div className="relative z-10 px-4 md:px-12">
        <h1 className="text-3xl sm:text-6xl md:text-7xl font-oswald font-bold tracking-wider text-white drop-shadow-hero text-center mb-2">
          JAMES AUGUSTUS HALL
        </h1>
        <p className="text-yellow-300 font-oswald font-bold text-2xl sm:text-4xl md:text-5xl tracking-wider drop-shadow-hero text-center mb-1">
