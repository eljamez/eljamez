...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <div
        className={`bg-gradient-to-br bg-blend-saturation from-zinc-400/40 to-white/30 rounded-lg p-0 shadow  overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl group min-h-[320px] sm:min-h-[420px] flex flex-col backdrop-blur-md ${className}`}
      >
        <Image
          src={project.image}
          alt={project.title}
