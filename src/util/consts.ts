...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/grid-lol.png",
    tech: ["Next.js", "TypeScript", "TailwindCSS", "YouTube API"],
    slug: "grid-lol",
    details:
  ...
  },
  {
    ...
    description:
      "A device management dashboard for Aimi Player Pro, enabling users to manage device licenses, subscriptions, and access features like multi-device playback and offline music.",
    link: "#",
  ...
  },
  {
    title: "Aimi Sync",
    description:
      "A web app for synchronizing music playback across multiple devices, enabling seamless group listening experiences.",
    link: "https://sync.aimi.fm",
    image: "/aimi-sync.png",
    tech: ["Next.js", "TypeScript", "TailwindCSS", "WebSockets"],
    slug: "aimi-sync",
    details:
      "Aimi Sync allows users to synchronize music playback in real time across different devices and locations. Designed for collaborative listening, parties, and remote music sessions, Aimi Sync leverages WebSockets for low-latency communication, ensuring everyone stays in perfect sync. The app features easy room creation, device management, and robust controls for hosts and participants.",
    employer: "Aimi.fm",
  },
  {
    title: "Aimi Studio",
    ...
    tech: ["Next.js", "TypeScript", "TailwindCSS", "Web Audio API", "React"],
    slug: "aimi-studio",
    details:
      "Aimi Studio is an innovative web-based platform for creating and sharing generative music. It provides intuitive tools for composing, editing, and collaborating on music projects, leveraging the power of the Web Audio API for real-time audio processing. Users can experiment with generative elements, collaborate in real time, and publish their creations to the Aimi ecosystem. The platform is designed for musicians, producers, and enthusiasts seeking new ways to explore and share music.",
    employer: "Aimi.fm",
  },
  {
    title: "Splice Desktop",
    description:
      "A desktop application for seamless sample management, cloud syncing, and integration with music production workflows.",
    link: "#",
    image: "/splice-desktop.png",
    tech: ["Electron", "TypeScript", "React", "Node.js"],
    slug: "splice-desktop",
    details:
      "Splice Desktop is a cross-platform desktop app designed for music producers to manage, sync, and organize their sample libraries. It offers deep integration with DAWs, cloud-based backup and syncing, and intuitive tools for browsing, auditioning, and importing samples. Built with Electron and React, Splice Desktop streamlines the creative workflow, making it easy to access and use samples in any production environment.",
    employer: "Splice",
  },
  {
    title: "1stDibs",
    ...
    link: "#",
    image: "/1stDibs.png",
    tech: ["React", "TypeScript", "Node.js", "GraphQL", "Next.js"],
    slug: "1stdibs",
    details:
  ...
  },
  {
    ...
    tech: ["Web", "Mobile", "Mastercard APIs", "Digital Wallet"],
    slug: "masterpass",
    details:
  ...
  },
  {
    ...
    link: "#",
    image: "/NikeID.png",
    tech: ["Web", "3D Visualization", "E-commerce", "Customization Engine"],
    slug: "nikeid",
    details:
